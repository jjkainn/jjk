							...
							<a class="btn btn-lg btn-success" onclick="fresh();" style="*margin-left: 43%;"><?php echo $Lan_Main["RefreshWifiList"][$Language_Type];?></a>
								...
								<tbody>
									...
									<tr>
										...
										<td colspan="4"><h4><?php echo $Lan_Main["UsingWLAN"][$Language_Type];?></h4></td>
										
										
									</tr>
									<!--<tr>
										<td colspan="4">已连接的网络</td>
									</tr>-->
									<?php 
										$ret = getWifiConnNode();
//										echo $ret['SSID'];
...
<!--									附近的wifi-->
									<tr>
										...
										<td colspan="4"><h4><?php echo $Lan_Main["NearbyWLAN"][$Language_Type];?></h4></td>
