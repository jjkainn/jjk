...
cal = (cal==null) ? new Calendar(by, ey, plang) : cal;    //不用每次都初始化 2006-12-03 修正 
...
mvAry[mvAry.length] = ' <div id="divCalendarForm" name="calendarForm" style="margin: 0px;">'; 
